    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'password1'].help_text = '<ul class="form-text text-muted small"><li>Your password can\'t be too similar to' \
                                     ' your other personal information.</li><li>Your password must contain at least ' \
                                     '8 characters.</li><li>Your password can\'t be a commonly used password.</li>' \
        ...
        self.fields[
            'password2'].help_text = '<span class="form-text text-muted"><small>Enter the same password as before, for ' \
                                     'verification.</small></span>'
